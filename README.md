...
| `popup.js` | 659 | Popup 交互、过滤、下载、AI 配置、拖拽缩放 |
| `popup.css` | 477 | UI 样式与拖拽缩放样式 |
| `popup.html` | 138 | 页面结构 |
...
| 版本 | 说明 |
|------|------|
| v0.0.2 | 新增单条请求 AI 分析、独立模型列表 URL、模型下拉选择、AI 结果区滚动优化、Popup 等比例拖拽缩放 |
...
- 默认使用较小 Popup 窗口，右下角支持鼠标拖拽等比例缩放，缩放状态自动记忆
